...
import com.raju.messengar.databinding.ItemRecievedContainerBinding;
import com.raju.messengar.databinding.ItemsUserSentContainerBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType==VIEW_TYPE_SENT){
            ...
            return new ReceivedMessageViewHolder(ItemRecievedContainerBinding.inflate(
                    LayoutInflater.from(parent.getContext()),parent,false));
        }
    }
    ...
    static class ReceivedMessageViewHolder extends RecyclerView.ViewHolder{
        private final ItemRecievedContainerBinding receivedContainerBinding;
        ReceivedMessageViewHolder(ItemRecievedContainerBinding itemRecievedContainerBinding){
